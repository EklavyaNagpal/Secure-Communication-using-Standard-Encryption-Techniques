...
int Rcon[255] = { //This will be used in key expansion
...
/*printf("Enter the sentence to be formatted:\n");
...
printf("Formated sentence is : %s \n",newsentence);                

//strcpy(zero,newsentence);
